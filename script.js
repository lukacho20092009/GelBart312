...

{
  ...
  },
  {
    ...
    desc: '"ClownFish". Acrylic. 36X24 In. (100X61 Cm). location: USA.',
    sold: false,
    variations: [],
  },
  {
  ...
  },
  {
    id: 248,
    title: '',
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766509347/598739093_1478318947296426_6083794534970014736_n_n6uwuq.jpg',
    desc: '',
    sold: true,
    variations: [],
  },
  ...
  },
  {
    ...
    desc: '"Spy Reaction". Mascara. A3. location: USA. ',
    price: 1100,
    sold: false,
    variations: [],
  },
...

{
  id: 176,
  title: 'Husband-Wife',
  img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766512541/as_trh2he.jpg',
...

{
  id: 154,
  title: 'Fairy',
  img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766254144/13489976-fabe-4c9f-9511-714c1e2998f0_haviuk.jpg',
  desc: '"Fairy". Ink. A4.',
  sold: true,
  variations: [],
},
...

{
  ...
  desc: '"Galaxy". Ink. A3. location: USA.',
  sold: false,
  variations: [],
},
...

{
  ...
  title: 'Che',
  price: 750,
  img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766254128/fb665ab3-c936-4c4f-826a-324a566ed38c_q7lcqh.jpg',
...

{
  ...
  desc: '"Cube". White and Silver Ink. A4. location: USA.',
  sold: false,
  variations: [],
},
...

{
  ...
  desc: '"Planets". Ink and Coffe. A4. location: USA.',
  sold: false,
  variations: [],
},
...

{
  id: 122,
  title: 'Teeth',
  img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253954/ecb71e83-a7f8-4105-9d69-7685de42175d_vfmymg.jpg',
  desc: '"Teeth". Ink.',
  sold: true,
  variations: [],
},
...

{
  id: 116,
  title: 'Donki',
  img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253935/0cb13bd5-9dbf-4362-9466-82632bc90ffc_g3vrkn.jpg',
  desc: '"Donki". Ink. A4.',
  sold: true,
  variations: [],
},

{
  id: 115,
  title: 'Blood',
  img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253915/427a0b6e-a8f8-4c0e-a1b6-df598bc14d14_vcwek2.jpg',
...
},
{
    ...
    desc: '"My November". Ink. A4. location: USA. ',
    sold: false,
    variations: [],
},
{
...
},
{
    ...
    desc: '"Another World". A4. location: USA. ',
    sold: false,
    variations: [],
},
{
    ...
    desc: '"Lost in Space". Ink. A3. location: Georgia.',
    sold: false,
    variations: [],
},
{
...
},
{
    ...
    title: 'Elephant',
    price: 700,
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766254012/67085a86-d835-49eb-860d-92368c4999ce_iexgvh.jpg',
...
},
{
    id: 64,
    title: 'Elephant',
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253895/548f0d26-9749-4964-ba3a-c0ebd9541319_ulkm4w.jpg',
    desc: '"Elephant". Ink. A4.',
    sold: true,
    variations: [],
},
...
},
{
    id: 61,
    title: 'Fish',
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253858/2f337dbd-ac48-4137-96ae-d104ad6514db_rgkaro.jpg',
    desc: '"Fish". Ink. A4.',
    sold: true,
    variations: [],
},
...
},
{
    ...
    title: 'FingerPrint',
    price: 950,
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253841/2e43a40e-c6a0-42cb-9d34-d0c92e3cdde0_akv883.jpg',
...
},
{
    ...
    title: 'Easter Egg',
    price: 950,
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253824/0af7b1fc-9ecd-4a3a-8461-dea6ff84301d_1_uq31rp.jpg',
...

{
  ...
  },
  {
    id: 10,
    title: '',
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253767/5b7ee1a9-5695-4a1e-b1e8-1ef549ec2d24_rqmpkm.jpg',
    desc: '',
    sold: true,
    variations: [],
  },
  ...
  },
  {
    ...
    title: 'Hands',
    price: 1300,
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253753/8a090625-c080-4e90-a26e-6aa96bb3a097_uhaxcn.jpg',
  ...
  },
  {
    ...
    title: 'Sink Spiral',
    price: 950,
    img: 'https://res.cloudinary.com/dri8nh3tr/image/upload/v1766253691/174eb56c-db7a-4c19-8753-3cf518563e04_vwmncy.jpg',
    desc: '"Sink Spiral". White Ink. A3. location: USA.',
    sold: false,
    variations: [],
  },
  {
...
const translations = {
  en: {
    ...
    "hero.subtitle": "Our life may not be long, but our works will endure for centuries.",
    "hero.cta": "View Gallery",
    "hero.atc": "Contact",

    "about.text": "Artist D. Gelbakhiani was born in 1975 in Tbilisi, Georgia. He currently lives and works in the United States of America. He has held three solo exhibitions: two in Georgia (Tbilisi) and one in the United States (Las Vegas). Many more exhibitions are planned in various countries. The artist’s signature style is completely different from that of other artists, making his work and paintings distinctive and unique.",
    "about.gallery": "Explore Gallery",
    "about.videos": "Artist’s work videos",

    "card.gallery": "Gallery",
    "card.print-pictures": "Print Pictures",
    "card.print-clothes": "Print on Clothes",
    "card.about": "About the Artist",
    "badge.signature": "Original Signature Included",

     "contact.title": "Contact Us",
     "contact.phone": "Phone:",
     "contact.email": "Email:",
     "contact.location": "Location:",
     "contact.message-note": "Please message us on the phone number, as we may not always be able to answer calls. If you're interested, just send us a message.",
     "contact.write-email": "Write the Email",

    "order.title": "Order by Size",
     "order.customize": "Customize Your Painting",
     "order.unit": "Unit:",
     "order.size": "Size:",
     "order.resolution": "Resolution:",
     "order.price": "Price:",
     "order.note-signature": "Each painting will include the artist's original signature.",
     "order.note-custom-size": "If you would like different sizes, please contact us.",
     "order.button": "Contact to Order"
  ...
  ka: {
    ...
    "hero.subtitle": "ჩვენი ცხოვრება შეიძლება ხანგრძლივი არ იყოს, მაგრამ ჩვენი ნამუშევრები საუკუნეებს გაუძლებს.",
    "hero.cta": "ნახე გალერეა",
    "hero.atc": "კონტაქტი",

    "about.text": "მხატვარი დ. გელბახიანი დაიბადა 1975 წელს ქ. თბილისში, საქართველო. ამჟამად ცხოვრობს და მოღვაწეობს ამერიკის შეერთებულ შტატებში. აქვს ჩატარებული სამი პერსონალური გამოფენა: ორი საქართველოში (თბილისი) და ერთი ამერიკაში (ლას ვეგასი). იგეგმება კიდევ მრავალი გამოფენა სხვადასხვა ქვეყნებში. მხატვრის ხელწერა სრულიად განსხვავებულია სხვა მხატვრებისგან, რაც მის ნამუშევრებს გამორჩეულსა და უნიკალურს ხდის.",
    "about.gallery": "გალერეის ნახვა",
    "about.videos": "მხატვრის ნამუშევრების ვიდეოები",

    "card.gallery": "გალერეა",
    "card.print-pictures": "ნახატების ბეჭდვა",
    "card.print-clothes": "ბეჭდვა ტანსაცმელზე",
    "card.about": "მხატვარის შესახებ",
    "badge.signature": "მხატვრის ორიგინალი ხელმოწერა",

    "contact.title": "კონტაქტი",
    "contact.phone": "ტელეფონი:",
    "contact.email": "ელფოსტა:",
    "contact.location": "მდებარეობა:",
    "contact.message-note": "გთხოვთ, მოგვწეროთ მითითებულ ნომერზე, რადგან ყოველთვის ვერ ვახერხებთ ზარის მიღებას. დაინტერესების შემთხვევაში უბრალოდ მოგვწერეთ.",
    "contact.write-email": "ელფოსტის მიწერა",

    "order.title": "ზომის მიხედვით შეკვეთა",
    "order.customize": "ნახატის მორგება",
    "order.unit": "ერთეული:",
    "order.size": "ზომა:",
    "order.resolution": "რეზოლუცია:",
    "order.price": "ფასი:",
    "order.note-signature": "ყველა ნახატი მოიცავს მხატვრის ორიგინალ ხელმოწერას.",
    "order.note-custom-size": "თუ თქვენ გსურთ განსხვავებული ზომები, დაგვიკავშირდით.",
    "order.button": "დაგვიკავშირდით შეკვეთისთვის"
  ...
  es: {
    ...
    "hero.title": "Arte de David Gelbakhiani",
    "hero.subtitle": "Nuestra vida puede no ser larga, pero nuestras obras perdurarán durante siglos.",
    "hero.cta": "Ver Galería",
    "hero.atc": "Contacto",

    "about.text": "El artista D. Gelbakhiani nació en 1975 en Tiflis, Georgia. Actualmente vive y trabaja en los Estados Unidos de América. Ha realizado tres exposiciones individuales: dos en Georgia (Tiflis) y una en los Estados Unidos (Las Vegas). Se planean muchas más exposiciones en varios países. El estilo característico del artista es completamente diferente al de otros artistas, lo que hace que sus obras sean distintivas y únicas.",
    "about.gallery": "Explorar Galería",
    "about.videos": "Videos de las obras del artista",

    "card.gallery": "Galería",
    "card.print-pictures": "Impresión de cuadros",
    "card.print-clothes": "Impresión en ropa",
    "card.about": "Sobre el artista",
    "badge.signature": "Firma original incluida",

    "contact.title": "Contáctanos",
    "contact.phone": "Teléfono:",
    "contact.email": "Correo electrónico:",
    "contact.location": "Ubicación:",
    "contact.message-note": "Por favor envíanos un mensaje al número de teléfono, ya que no siempre podemos responder llamadas. Si estás interesado, simplemente escríbenos.",
    "contact.write-email": "Escribir el correo",

    "order.title": "Pedido por tamaño",
    "order.customize": "Personaliza tu pintura",
    "order.unit": "Unidad:",
    "order.size": "Tamaño:",
    "order.resolution": "Resolución:",
    "order.price": "Precio:",
    "order.note-signature": "Cada pintura incluirá la firma original del artista.",
    "order.note-custom-size": "Si deseas tamaños diferentes, contáctanos.",
    "order.button": "Contactar para pedir"
  ...
  ru: {
    ...
    "hero.title": "Искусство Давида Гелбахяни",
    "hero.subtitle": "Наша жизнь может быть недолгой, но наши произведения переживут века.",
    "hero.cta": "Смотреть галерею",
    "hero.atc": "Контакт",

    "about.text": "Художник Д. Гелбахяни родился в 1975 году в Тбилиси, Грузия. В настоящее время живёт и работает в Соединённых Штатах Америки. Он провёл три персональные выставки: две в Грузии (Тбилиси) и одну в США (Лас-Вегас). Планируется ещё множество выставок в разных странах. Авторский стиль художника полностью отличается от других, что делает его работы уникальными и узнаваемыми.",
    "about.gallery": "Посмотреть галерею",
    "about.videos": "Видео работ художника",

    "card.gallery": "Галерея",
    "card.print-pictures": "Печать картин",
    "card.print-clothes": "Печать на одежде",
    "card.about": "О художнике",
    "badge.signature": "Включена оригинальная подпись",

    "contact.title": "Свяжитесь с нами",
    "contact.phone": "Телефон:",
    "contact.email": "Электронная почта:",
    "contact.location": "Местоположение:",
    "contact.message-note": "Пожалуйста, напишите нам по указанному номеру телефона, так как мы не всегда можем ответить на звонки. Если вы заинтересованы — просто напишите нам.",
    "contact.write-email": "Написать письмо",

    "order.title": "Заказ по размеру",
    "order.customize": "Настройте свою картину",
    "order.unit": "Единица:",
    "order.size": "Размер:",
    "order.resolution": "Разрешение:",
    "order.price": "Цена:",
    "order.note-signature": "Каждая картина будет с оригинальной подписью художника.",
    "order.note-custom-size": "Если вы хотите другие размеры, пожалуйста, свяжитесь с нами.",
    "order.button": "Связаться для заказа"
...
document.querySelectorAll("[data-lang]").forEach(btn => {
  btn.addEventListener("click", e => {
    ...
    if (langSelector) langSelector.innerText = e.target.innerText;
    setLanguage(lang);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const previewImg = document.getElementById("paintingPreview");

  const RATIO = 2 / 3;
  const INCH_TO_CM = 2.54;

  // საწყისი ზომა 36x24
  sizeNumber.dataset.width = 36;
  sizeNumber.value = "36 × 24";

  function updateValues() {
    let widthInch = Number(sizeNumber.dataset.width);
    let heightInch = Math.round(widthInch * RATIO);

    let widthCm = Math.round(widthInch * INCH_TO_CM);
    let heightCm = Math.round(heightInch * INCH_TO_CM);
    ...
    if (unitSelect.value === "cm") {
      ...
      widthValue.textContent = widthInch;
      heightValue.textContent = heightInch;
      unitLabel.textContent = "In";
    }

    sizeNumber.value = `${widthValue.textContent} × ${heightValue.textContent}`;

    resValue.textContent = `${widthInch * 300} × ${heightInch * 300}`;

    const basePrice = 80;
    const pricePerInch = 6;
    priceValue.textContent = Math.round(basePrice + widthInch * pricePerInch);

    const scale = widthInch / 50;
    previewImg.style.transform = `scale(${scale})`;
  }

  decreaseBtn.addEventListener("click", () => {
    let current = Number(sizeNumber.dataset.width);
    current = Math.max(12, current - 6);
    sizeNumber.dataset.width = current;
    updateValues();
  });

  increaseBtn.addEventListener("click", () => {
    let current = Number(sizeNumber.dataset.width);
    current = Math.min(48, current + 6);
    sizeNumber.dataset.width = current;
    updateValues();
  });

  sizeNumber.addEventListener("input", () => {
    let parts = sizeNumber.value.split("×");
    let widthInput = Number(parts[0].trim());
    if (isNaN(widthInput)) widthInput = 36;
    widthInput = Math.max(12, Math.min(48, widthInput));
    sizeNumber.dataset.width = widthInput;
    updateValues();
  });

  unitSelect.addEventListener("change", updateValues);
...
sizeRange.addEventListener("touchstart", e => {
  e.stopPropagation();
}, { passive: false });
